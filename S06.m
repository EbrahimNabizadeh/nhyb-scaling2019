function S06(mstart,mend,summer,current)
%Scaling between 30-60. std max
if current==1
    lat  = ncread('/current/b.e11.B20TRC5CNBDRD.f09_g16.002.cam.h1.Z500.19200101-20051231.nc','lat');
    lon  = ncread('/current/b.e11.B20TRC5CNBDRD.f09_g16.002.cam.h1.Z500.19200101-20051231.nc','lon');
else
    lat  = ncread('/future/b.e11.BRCP85C5CNBDRD.f09_g16.001.cam.h1.Z500.20060101-20801231.nc','lat');
    lon  = ncread('/future/b.e11.BRCP85C5CNBDRD.f09_g16.001.cam.h1.Z500.20060101-20801231.nc','lon');
end
SH_last_index=96;
...
%summer
SFD=152;        %Summer First Day:SFD
SLD=243;        %Summer Last Day:SLD
daysummer = 92; %all summer days
%winter
WFD=335;        %Winter First Day:SFD
WLD=424;        %Winter Last Day:SLD
daywinter = 90; %all winter days
